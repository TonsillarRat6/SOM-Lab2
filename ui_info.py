...
class UIInfo:
	...
	amount_tickets: UITicketAmount.AmountTickets

	def __init__(self, from_station: str, to_station: str, travel_class: UIClass, way: UIWay, discount: UIDiscount, payment: UIPayment, amount_tickets: int):
